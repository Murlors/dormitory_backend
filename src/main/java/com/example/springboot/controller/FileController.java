...
public class FileController {
    ...
    @ApiOperation("将上传的头像写入本地 rootFilePath")
    ...
    @ApiOperation("初始化头像")//前端调用接口，后端查询存储与本地的头像，进行Base64编码 发送到前端
    @ApiImplicitParam(name = "filename", value = "头像名称", required = true, dataType = "String")
